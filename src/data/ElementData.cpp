...
// Covalent radii: Cordero et al.; see resources/covalent_radii.md.
// VdW radii (Angstrom): ASE 3.25.0 ase/data/vdw_alvarez.py, Alvarez (2013),
// Dalton Trans. 42, 8617-8636, https://doi.org/10.1039/C3DT50599E.
// ASE flags He, Ne, Ac, Pa, Cm, Bk, Cf and Es as having larger uncertainty.
// Retain legacy VdW fallbacks where Alvarez data is missing: Pm, Po, At,
// Rn, Fr, Ra, and Z >= 100, plus the unknown placeholder X.
// These fallbacks are not from Alvarez; their provenance is not fully verified.
constexpr std::array<ElementInfo, ElementData::MAX_ELEMENTS> kElements = {{
    ...
    {2, "He", "Helium", 4.003f, 0.28f, 1.43f, Color(0.851f, 1.000f, 1.000f)},
    // Period 2
    {3, "Li", "Lithium", 6.941f, 1.28f, 2.12f, Color(0.800f, 0.502f, 1.000f)},
    {4, "Be", "Beryllium", 9.012f, 0.96f, 1.98f, Color(0.761f, 1.000f, 0.000f)},
    {5, "B", "Boron", 10.81f, 0.85f, 1.91f, Color(1.000f, 0.710f, 0.710f)},
    {6, "C", "Carbon", 12.01f, 0.76f, 1.77f, Color(0.565f, 0.565f, 0.565f)},
    {7, "N", "Nitrogen", 14.01f, 0.71f, 1.66f, Color(0.188f, 0.314f, 0.973f)},
    {8, "O", "Oxygen", 16.00f, 0.66f, 1.50f, Color(1.000f, 0.051f, 0.051f)},
    {9, "F", "Fluorine", 19.00f, 0.57f, 1.46f, Color(0.565f, 0.878f, 0.314f)},
    {10, "Ne", "Neon", 20.18f, 0.58f, 1.58f, Color(0.702f, 0.890f, 0.961f)},
    // Period 3
    {11, "Na", "Sodium", 22.99f, 1.66f, 2.50f, Color(0.671f, 0.361f, 0.949f)},
    {12, "Mg", "Magnesium", 24.31f, 1.41f, 2.51f, Color(0.541f, 1.000f, 0.000f)},
    {13, "Al", "Aluminum", 26.98f, 1.21f, 2.25f, Color(0.749f, 0.651f, 0.651f)},
    {14, "Si", "Silicon", 28.09f, 1.11f, 2.19f, Color(0.941f, 0.784f, 0.627f)},
    {15, "P", "Phosphorus", 30.97f, 1.07f, 1.90f, Color(1.000f, 0.502f, 0.000f)},
    {16, "S", "Sulfur", 32.07f, 1.05f, 1.89f, Color(1.000f, 1.000f, 0.188f)},
    {17, "Cl", "Chlorine", 35.45f, 1.02f, 1.82f, Color(0.122f, 0.941f, 0.122f)},
    {18, "Ar", "Argon", 39.95f, 1.06f, 1.83f, Color(0.502f, 0.820f, 0.890f)},
    // Period 4
    {19, "K", "Potassium", 39.10f, 2.03f, 2.73f, Color(0.561f, 0.251f, 0.831f)},
    {20, "Ca", "Calcium", 40.08f, 1.76f, 2.62f, Color(0.239f, 1.000f, 0.000f)},
    {21, "Sc", "Scandium", 44.96f, 1.70f, 2.58f, Color(0.902f, 0.902f, 0.902f)},
    {22, "Ti", "Titanium", 47.87f, 1.60f, 2.46f, Color(0.749f, 0.761f, 0.780f)},
    {23, "V", "Vanadium", 50.94f, 1.53f, 2.42f, Color(0.651f, 0.651f, 0.671f)},
    {24, "Cr", "Chromium", 52.00f, 1.39f, 2.45f, Color(0.541f, 0.600f, 0.780f)},
    {25, "Mn", "Manganese", 54.94f, 1.39f, 2.45f, Color(0.612f, 0.478f, 0.780f)},
    {26, "Fe", "Iron", 55.85f, 1.32f, 2.44f, Color(0.878f, 0.400f, 0.200f)},
    {27, "Co", "Cobalt", 58.93f, 1.26f, 2.40f, Color(0.941f, 0.565f, 0.627f)},
    {28, "Ni", "Nickel", 58.69f, 1.24f, 2.40f, Color(0.314f, 0.816f, 0.314f)},
    {29, "Cu", "Copper", 63.55f, 1.32f, 2.38f, Color(0.784f, 0.502f, 0.200f)},
    {30, "Zn", "Zinc", 65.38f, 1.22f, 2.39f, Color(0.490f, 0.502f, 0.690f)},
    {31, "Ga", "Gallium", 69.72f, 1.22f, 2.32f, Color(0.761f, 0.561f, 0.561f)},
    {32, "Ge", "Germanium", 72.63f, 1.20f, 2.29f, Color(0.400f, 0.561f, 0.561f)},
    {33, "As", "Arsenic", 74.92f, 1.19f, 1.88f, Color(0.741f, 0.502f, 0.890f)},
    {34, "Se", "Selenium", 78.97f, 1.20f, 1.82f, Color(1.000f, 0.631f, 0.000f)},
    {35, "Br", "Bromine", 79.90f, 1.20f, 1.86f, Color(0.651f, 0.161f, 0.161f)},
    {36, "Kr", "Krypton", 83.80f, 1.16f, 2.25f, Color(0.361f, 0.722f, 0.820f)},
    // Period 5
    {37, "Rb", "Rubidium", 85.47f, 2.20f, 3.21f, Color(0.439f, 0.180f, 0.690f)},
    {38, "Sr", "Strontium", 87.62f, 1.95f, 2.84f, Color(0.000f, 1.000f, 0.000f)},
    {39, "Y", "Yttrium", 88.91f, 1.90f, 2.75f, Color(0.580f, 1.000f, 1.000f)},
    {40, "Zr", "Zirconium", 91.22f, 1.75f, 2.52f, Color(0.580f, 0.878f, 0.878f)},
    {41, "Nb", "Niobium", 92.91f, 1.64f, 2.56f, Color(0.451f, 0.761f, 0.788f)},
    {42, "Mo", "Molybdenum", 95.95f, 1.54f, 2.45f, Color(0.329f, 0.710f, 0.710f)},
    {43, "Tc", "Technetium", 98.00f, 1.47f, 2.44f, Color(0.231f, 0.620f, 0.620f)},
    {44, "Ru", "Ruthenium", 101.1f, 1.46f, 2.46f, Color(0.141f, 0.561f, 0.561f)},
    {45, "Rh", "Rhodium", 102.9f, 1.42f, 2.44f, Color(0.039f, 0.490f, 0.549f)},
    {46, "Pd", "Palladium", 106.4f, 1.39f, 2.15f, Color(0.000f, 0.412f, 0.522f)},
    {47, "Ag", "Silver", 107.9f, 1.45f, 2.53f, Color(0.753f, 0.753f, 0.753f)},
    {48, "Cd", "Cadmium", 112.4f, 1.44f, 2.49f, Color(1.000f, 0.851f, 0.561f)},
    {49, "In", "Indium", 114.8f, 1.42f, 2.43f, Color(0.651f, 0.459f, 0.451f)},
    {50, "Sn", "Tin", 118.7f, 1.39f, 2.42f, Color(0.400f, 0.502f, 0.502f)},
    {51, "Sb", "Antimony", 121.8f, 1.39f, 2.47f, Color(0.620f, 0.388f, 0.710f)},
    {52, "Te", "Tellurium", 127.6f, 1.38f, 1.99f, Color(0.831f, 0.478f, 0.000f)},
    {53, "I", "Iodine", 126.9f, 1.39f, 2.04f, Color(0.580f, 0.000f, 0.580f)},
    {54, "Xe", "Xenon", 131.3f, 1.40f, 2.06f, Color(0.259f, 0.620f, 0.690f)},
    // Period 6
    {55, "Cs", "Cesium", 132.9f, 2.44f, 3.48f, Color(0.341f, 0.090f, 0.561f)},
    {56, "Ba", "Barium", 137.3f, 2.15f, 3.03f, Color(0.000f, 0.788f, 0.000f)},
    {57, "La", "Lanthanum", 138.9f, 2.07f, 2.98f, Color(0.439f, 0.831f, 1.000f)},
    {58, "Ce", "Cerium", 140.1f, 2.04f, 2.88f, Color(1.000f, 1.000f, 0.780f)},
    {59, "Pr", "Praseodymium", 140.9f, 2.03f, 2.92f, Color(0.851f, 1.000f, 0.780f)},
    {60, "Nd", "Neodymium", 144.2f, 2.01f, 2.95f, Color(0.780f, 1.000f, 0.780f)},
    {61, "Pm", "Promethium", 145.0f, 1.99f, 2.36f, Color(0.639f, 1.000f, 0.780f)},
    {62, "Sm", "Samarium", 150.4f, 1.98f, 2.90f, Color(0.561f, 1.000f, 0.780f)},
    {63, "Eu", "Europium", 152.0f, 1.98f, 2.87f, Color(0.380f, 1.000f, 0.780f)},
    {64, "Gd", "Gadolinium", 157.3f, 1.96f, 2.83f, Color(0.271f, 1.000f, 0.780f)},
    {65, "Tb", "Terbium", 158.9f, 1.94f, 2.79f, Color(0.188f, 1.000f, 0.780f)},
    {66, "Dy", "Dysprosium", 162.5f, 1.92f, 2.87f, Color(0.122f, 1.000f, 0.780f)},
    {67, "Ho", "Holmium", 164.9f, 1.92f, 2.81f, Color(0.000f, 1.000f, 0.612f)},
    {68, "Er", "Erbium", 167.3f, 1.89f, 2.83f, Color(0.000f, 0.902f, 0.459f)},
    {69, "Tm", "Thulium", 168.9f, 1.90f, 2.79f, Color(0.000f, 0.831f, 0.322f)},
    {70, "Yb", "Ytterbium", 173.0f, 1.87f, 2.80f, Color(0.000f, 0.749f, 0.220f)},
    {71, "Lu", "Lutetium", 175.0f, 1.87f, 2.74f, Color(0.000f, 0.671f, 0.141f)},
    {72, "Hf", "Hafnium", 178.5f, 1.75f, 2.63f, Color(0.302f, 0.761f, 1.000f)},
    {73, "Ta", "Tantalum", 180.9f, 1.70f, 2.53f, Color(0.302f, 0.651f, 1.000f)},
    {74, "W", "Tungsten", 183.8f, 1.62f, 2.57f, Color(0.129f, 0.580f, 0.839f)},
    {75, "Re", "Rhenium", 186.2f, 1.51f, 2.49f, Color(0.149f, 0.490f, 0.671f)},
    {76, "Os", "Osmium", 190.2f, 1.44f, 2.48f, Color(0.149f, 0.400f, 0.588f)},
    {77, "Ir", "Iridium", 192.2f, 1.41f, 2.41f, Color(0.090f, 0.329f, 0.529f)},
    {78, "Pt", "Platinum", 195.1f, 1.36f, 2.29f, Color(0.816f, 0.816f, 0.878f)},
    {79, "Au", "Gold", 197.0f, 1.36f, 2.32f, Color(1.000f, 0.820f, 0.137f)},
    {80, "Hg", "Mercury", 200.6f, 1.32f, 2.45f, Color(0.722f, 0.722f, 0.816f)},
    {81, "Tl", "Thallium", 204.4f, 1.45f, 2.47f, Color(0.651f, 0.329f, 0.302f)},
    {82, "Pb", "Lead", 207.2f, 1.46f, 2.60f, Color(0.341f, 0.349f, 0.380f)},
    {83, "Bi", "Bismuth", 209.0f, 1.48f, 2.54f, Color(0.620f, 0.310f, 0.710f)},
    {84, "Po", "Polonium", 209.0f, 1.40f, 1.97f, Color(0.671f, 0.361f, 0.000f)},
    {85, "At", "Astatine", 210.0f, 1.50f, 2.02f, Color(0.459f, 0.310f, 0.271f)},
    {86, "Rn", "Radon", 222.0f, 1.50f, 2.20f, Color(0.259f, 0.510f, 0.588f)},
    // Period 7
    {87, "Fr", "Francium", 223.0f, 2.60f, 3.48f, Color(0.259f, 0.000f, 0.400f)},
    {88, "Ra", "Radium", 226.0f, 2.21f, 2.83f, Color(0.000f, 0.490f, 0.000f)},
    {89, "Ac", "Actinium", 227.0f, 2.15f, 2.80f, Color(0.439f, 0.671f, 0.980f)},
    {90, "Th", "Thorium", 232.0f, 2.06f, 2.93f, Color(0.000f, 0.729f, 1.000f)},
    {91, "Pa", "Protactinium", 231.0f, 2.00f, 2.88f, Color(0.000f, 0.631f, 1.000f)},
    {92, "U", "Uranium", 238.0f, 1.96f, 2.71f, Color(0.000f, 0.561f, 1.000f)},
    {93, "Np", "Neptunium", 237.0f, 1.90f, 2.82f, Color(0.000f, 0.502f, 1.000f)},
    {94, "Pu", "Plutonium", 244.0f, 1.87f, 2.81f, Color(0.000f, 0.420f, 1.000f)},
    {95, "Am", "Americium", 243.0f, 1.80f, 2.83f, Color(0.329f, 0.361f, 0.949f)},
    {96, "Cm", "Curium", 247.0f, 1.69f, 3.05f, Color(0.471f, 0.361f, 0.890f)},
    // Z >= 97: no covalent radius defined (-1.0f)
    {97,  "Bk", "Berkelium",     247.0f, -1.0f, 3.40f, Color(0.541f, 0.310f, 0.890f)},
    {98,  "Cf", "Californium",   251.0f, -1.0f, 3.05f, Color(0.631f, 0.212f, 0.831f)},
    {99,  "Es", "Einsteinium",   252.0f, -1.0f, 2.70f, Color(0.702f, 0.122f, 0.831f)},
